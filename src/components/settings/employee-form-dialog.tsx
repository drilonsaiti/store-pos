                ...
                >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1.5">
                                <Label htmlFor="employee-pin">
                                    {employee?.pin ? 'New PIN' : 'PIN'} (4 digits)
                                </Label>
                            ...
                            <div className="flex flex-col gap-1.5">
                                <Label htmlFor="employee-confirm-pin">
                                    Confirm PIN
                                </Label>

                                <Input
                                    id="employee-confirm-pin"
                                    type="password"
                                    inputMode="numeric"
                                    maxLength={4}
                                    {...register('confirmPin')}
                    ...
                    {requirePin && employee?.pin && (
                        <p className="text-xs text-muted-foreground">
                            Leave blank and unchecked/re-checked has no effect
                            — enter a new 4-digit PIN to replace the current
                            one.
                        </p>
                    )}
