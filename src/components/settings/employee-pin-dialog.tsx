...
export function EmployeePinDialog({open, employeeName, onOpenChange, onSubmit}: Props) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-xs">
                ...
                {error && <p className="text-center text-sm text-destructive">Incorrect PIN, try again</p>}
