...
export function QuickAddProductDialog({
    ...
    const submit = handleSubmit(async (values) => {
        const productInput: ProductInput = {
            ...
            packageOption:
                values.saleUnit === 'piece' &&
                values.packageEnabled &&
                values.piecesPerPackage &&
                values.packagePrice
                    ? {
                          piecesPerPackage: values.piecesPerPackage,
                ...
                >
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex gap-2">
                            <label className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-md border px-3 py-2 text-sm has-[:checked]:border-primary has-[:checked]:text-primary">
                                <input
                                    type="radio"
                                    value="piece"
                                    className="sr-only"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <Label htmlFor="qa-purchasePrice">
                                Purchase price
                            </Label>
                    ...
                    {saleUnit === 'piece' && (
                        <div className="flex flex-col gap-3 rounded-md border p-3">
                            ...
                            {packageEnabled && (
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        <Label htmlFor="qa-piecesPerPackage">
                                            Pieces per package
                                        </Label>

                                        <Input
                                            id="qa-piecesPerPackage"
                                            type="number"
                                            step="1"
                                            min="1"
                                            {...register('piecesPerPackage')}
                                        />
